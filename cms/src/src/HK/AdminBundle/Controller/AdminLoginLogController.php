...
class AdminLoginLogController extends MasterController
{
    ...
    public function filterDefault(Request $req): void
    {
        ...
        $this->gridActions['71'] = [
            ...
            'class' => 'text-warning hk-reinit-action',
            'method' => FormHelper::$_METHOD_POST,
            'attr' => 'hk-data-is-confirm="1" hk-callback-after="hkadmin_reload" hk-data-is-confirm-text="' . $this->trans('lbl.action-confirm-lock-ip') . '"'
        ];
