...
class CmsUserType extends MasterFormType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('emailAddress', TextType::class, [
            ...
            'attr' => [
                'class' => FormHelper::$_FORM_VALIDATE_CLASS . ' hk-password-need-confirmed',
                FormHelper::$_VALIDATE_CLASS_CUSTOM => '1',
                FormHelper::$_VALIDATE_CLASS_CUSTOM_CALLBACK => 'hkadmin_validateCustom',
            ...
            'attr' => [
                ...
                FormHelper::$_REF_CLASS => 'hk-password-need-confirmed'
            ]
        ]);
