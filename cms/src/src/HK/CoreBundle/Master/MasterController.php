...
class MasterController extends AbstractController
{
    ...
    public static $_PHOTO_CLASS = 'hk-photo-list';
    ...
    public function addActionDisplayOrder(): void
    {
        if ($this->isDisplayOrder && $this->isPermissionEdit()) {
            $this->gridActions['21'] = [
                ...
                'class' => 'hk-reinit-action',
                'method' => FormHelper::$_METHOD_POST,
                'attr' => 'hk-data-params={"type":"' . DisplayOrderHelper::$_TYPE_UP . '"} hk-callback-after="hkadmin_reload"'
            ];
            $this->gridActions['22'] = [
                ...
                'class' => 'hk-reinit-action',
                'method' => FormHelper::$_METHOD_POST,
                'attr' => 'hk-data-params={"type":"' . DisplayOrderHelper::$_TYPE_DOWN . '"} hk-callback-after="hkadmin_reload"'
            ];
        }
    }
    ...
    public function filterDefault(Request $req): void
    {
        ...
        $this->gridActions['99'] = [
            ...
            'class' => 'text-danger hk-reinit-action',
            'method' => FormHelper::$_METHOD_POST,
            'attr' => 'hk-data-is-confirm="1" hk-callback-after="hkadmin_reload" hk-data-is-confirm-text="' . $this->trans('lbl.action-confirm-delete') . '"'
        ];
    }
    ...
    public function addDefaultMenuControl(): void
    {
        ...
        $this->menuControls[] = [
            ...
            'icon' => 'fas fa-plus',
            'class' => 'hk-reinit-url btn btn-success mb-2 ml-15 ',
            'method' => FormHelper::$_METHOD_GET,
            'attr' => ''
        ];
        ...
        //     'icon' => 'fas fa-check',
        //     'class' => 'hk-reinit-action btn btn-primary mb-2 ml-15 ',
        //     'method' => FormHelper::$_METHOD_POST,
        //     'attr' => 'hk-callback-after="hkadmin_reload" hk-data-params={"type":"' . PublishHelper::$_TYPE_PUBLISH . '"} hk-callback-before="hkadmin_menuControlBefore"'
        // ];
        // $this->menuControls[] = [
        //     'name' => 'unpublished',
        ...
        //     'class' => 'hk-reinit-action btn btn-secondary mb-2 ml-15 ',
        //     'method' => FormHelper::$_METHOD_POST,
        //     'attr' => 'hk-callback-after="hkadmin_reload" hk-data-params={"type":"' . PublishHelper::$_TYPE_UN_PUBLISHED . '"} hk-callback-before="hkadmin_menuControlBefore"'
        // ];
        if (!$this->isPermissionDelete()) {
            return;
        }
        $this->menuControls[] = [
            ...
            'url' => $this->generateUrl(Router::$_PREFIX . $this->controllerText . '.delete'),
            'icon' => 'far fa-trash-alt',
            'class' => 'hk-reinit-action btn btn-danger mb-2 ml-15 ',
            'method' => FormHelper::$_METHOD_POST,
            'attr' => 'hk-data-is-confirm="1" hk-callback-after="hkadmin_reload" hk-data-is-confirm-text="' . $this->trans('lbl.menu.confirm-delete') . '" hk-callback-before="hkadmin_menuControlBefore"'
        ];
    }
